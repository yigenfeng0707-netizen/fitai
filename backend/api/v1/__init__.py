...
from backend.api.v1 import auth, members, courses, bookings, coaches, orders, subscriptions, ai, leads, analytics, cards, notifications, audit, export, settings, campaign, automation, coupons, receipts
...
__all__ = ["api_router", "auth", "members", "courses", "bookings", "coaches", "orders", "subscriptions", "ai", "leads", "analytics", "cards", "notifications", "audit", "export", "settings", "campaign", "automation", "coupons", "receipts"]