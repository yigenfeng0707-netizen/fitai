...
from backend.api.v1 import auth, members, courses, bookings, coaches, orders, subscriptions, ai, leads, analytics, advanced_analytics, cards, notifications, audit, export, settings, campaign, automation, coupons, receipts, stores, marketing, reminders, mini_auth, mini_member, mini_course, mini_payment, etl, dashboard, agent
...
api_router.include_router(agent.router, prefix="/agent", tags=["Agent 智能体"])
