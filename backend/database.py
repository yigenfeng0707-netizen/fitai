...
async def init_db():
    ...
    from backend.models import member, course, booking, coach, auth, order, organization, body_test, recommendation, lead, campaign, automation, coupon, agent_log  # noqa: F401
